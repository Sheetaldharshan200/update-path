...
$stub = Join-Path $stubDir "exasol.cmd"
# $env:OS, not $IsWindows: the automatic variable does not exist on Windows
# PowerShell 5.1, where it evaluates to $null and would route the Windows
